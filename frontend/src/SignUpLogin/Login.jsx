  ...
  return (
    <div className = "h-screen max-lg:rounded-sm lg:w-2/4 lg:bg-white flex flex-col items-center lg:items-start">
      ...
      <div className = "flex flex-col justify-center lg:h-screen lg:mr-32">
        ...
        <p className = "font-extrabold font-marv text-4xl mt-11 max-md:text-[2rem] max-md:text-center">Log in for Clubs</p>
        <p className = "font-bold font-marv text-2xl mb-11 max-md:text-[1.15rem] max-md:text-center">Manage and showcase clubs events easily</p>
