    ...
    <div>
        ...
        <div className='groundoftheback'>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center gap-[5vw] py-[15vh]'>
                <button className='text-white lg:text-xl xl:text-2xl btn-clr rounded-xl px-10 py-2 mt-[2vh] xl:mt-[4vh] border hover:border-black font-thin'>Browse all Events</button>
                <button className='text-white lg:text-xl xl:text-2xl btn-clr rounded-xl px-14 py-2 mt-[2vh] xl:mt-[4vh] border hover:border-black font-thin'>Browse Clubs</button>
            </div>
        </div>
        <Footer />
    </div>
