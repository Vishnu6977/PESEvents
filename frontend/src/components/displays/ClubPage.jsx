...
const ClubPage = () => {
  ...
  const data = eventData.filter(event => clubData.events.includes(event.title));
  ...
  return (
    <div className='bg-white'>
      ...
      <div className='pt-[10vh] lg:pt-[12vh]'>
        ...
        <div className='flex low:flex-col lg:flex-row w-full mt-[10vh] lg:mt-[20vh] justify-between mb-[10vh] items-stretch'>
          ...
          <div className={`lg:max-w-[70vw] lg:ml-[10vh] xl:ml-[16vh] ${data.length === 0 ? 'w-[70vw]' : ''} `}>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:mr-[6vw] xl:mr-[10vw] sm:gap-x-[10vw] gap-y-[5vh] place-items-center mb-[10vh]'>
