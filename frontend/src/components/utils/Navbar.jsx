...
const Navbar = () => {
  return (
    <>
    <nav
    className='low:hidden lg:flex z-10 fixed top-0 left-0 w-full h-[12vh] flex flex-row items-center justify-between px-20 py-6 transition-colors duration-300 ease-in-out bg-black text-white'>
